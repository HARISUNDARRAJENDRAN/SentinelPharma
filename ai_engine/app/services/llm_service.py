"""
SentinelPharma LLM Service
======================
Unified interface for LLM calls with retry logic, rate limiting, and error handling.
Supports Google Gemini, Ollama (local), and Llama-cpp (local) models.
"""
...
class LLMService:
    """
    Unified LLM service supporting Gemini and local Llama models.
    ...
    async def generate_completion(
        ...
        """
        Generate completion using configured LLM (Gemini, Ollama, or Llama).
